...
export function ScrollHint() {
  ...
  return (
    ...
    >
      <span className="font-body text-[10px] uppercase tracking-[0.32em] text-[var(--theme-faint)] transition-colors duration-300">
        Scroll to explore
      </span>
      <div className="relative h-12 w-px overflow-hidden bg-[var(--theme-track)]">
