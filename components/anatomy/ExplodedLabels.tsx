  ...
  return (
    ...
    >
      ...
      {cfg.labels.map((def) => (
        ...
        >
          <span
            className={`explode-label flex items-center gap-2 whitespace-nowrap ${
          ...
          >
            ...
            <span className="h-px w-4 bg-[var(--theme-track)]" />
            <span className="font-body text-[11px] uppercase tracking-[0.18em] text-[var(--theme-label)] transition-colors duration-300">
              {def.title}
            </span>
          </span>
        </div>
