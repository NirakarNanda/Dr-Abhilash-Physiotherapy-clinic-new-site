...
export function AnatomyProgress() {
  ...
  return (
    ...
    >
      <span
        ref={numRef}
        className="font-editorial text-lg italic tabular-nums text-[var(--theme-ink)] transition-colors duration-300"
      >
        01
      </span>
      <span className="font-body text-[10px] uppercase tracking-[0.22em] text-[var(--theme-faint)] transition-colors duration-300">
        / 11
      </span>
      <div className="h-px w-24 overflow-hidden bg-[var(--theme-track)]">
        <div
          ref={barRef}
